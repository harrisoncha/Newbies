						...
						<div id="center" class="col-span-12 space-bottom-55">
							<div id="primary-login-center-view">
								<div class="modal-wrapper pull-center">
									<h1 class="color-30 text-center space-top space-bottom-5">Sign up</h1>
									<form id="primary-login-form" name = "signup-form" method="get">
										<div
										...
										<div  
											class="col-span-12 space-bottom-15 no-space-left no-space-right">
											<button type="submit" class="btn btn-primary btn-large modal-wrapper trigger void">Sign up</button>
										</div>
									</form>
								</div>
							</div>
