...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="margin-top: 40px">
      <div class="jumbotron p-3 p-md-5 text-white rounded" style="background: url(../img/mainDinner.jpg) no-repeat center center fixed; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
        <div class="col-md-6 px-0">
          <h1 class="display-4 font-italic">Discover the wonders of any city</h1>
        </div>
      </div>
    </div>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <footer class="container">
        ...
        <p>&copy; 2018 Newbies &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
      </footer>
    </main>
